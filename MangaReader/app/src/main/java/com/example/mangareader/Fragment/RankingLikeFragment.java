...
public class RankingLikeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ranking_like, container, false);
        ...
        Query query = table_comic.orderByChild("Like").limitToLast(5);
    ...
    private void AnhXa() {
        ...
        recyclerView = view.findViewById(R.id.recycler_ranking_like);
    }
}